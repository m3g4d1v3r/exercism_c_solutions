...
static void test_valid_when_11_digits_and_starting_with_1_even_with_punctuation(
    void) {
...
static void test_invalid_if_area_code_starts_with_0_on_valid_11_digit_number(
    void) {
...
static void test_invalid_if_area_code_starts_with_1_on_valid_11_digit_number(
    void) {
