...
static void test_word_with_duplicated_letter_in_mixed_case_lowercase_first(
    void) {
    TEST_ASSERT_FALSE(is_isogram("alphAbet"));
}
...
static void test_hypothetical_word_with_duplicated_character_following_hyphen(
    void) {
