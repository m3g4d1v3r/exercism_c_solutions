...
static void test_complex_conjugate_of_a_number_with_real_and_imaginary_part(
    void) {
...
static void test_exponential_resulting_in_number_with_real_and_imaginary_part(
    void) {
