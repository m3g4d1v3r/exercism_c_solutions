...
static void test_the_sound_for_15_is_plingplang_as_it_has_factors_3_and_5(
    void) {
    check_convert_drops(15, "PlingPlang");
}

static void test_the_sound_for_21_is_plingplong_as_it_has_factors_3_and_7(
    void) {
...
static void test_the_sound_for_35_is_plangplong_as_it_has_factors_5_and_7(
    void) {
