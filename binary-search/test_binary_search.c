...
static void test_a_value_smaller_than_the_arrays_smallest_value_is_not_found(
    void) {
    int arr[] = {1, 3, 4, 6, 8, 9, 11};
    size_t length = sizeof(arr) / sizeof(arr[0]);
...
static void test_a_value_larger_than_the_arrays_largest_value_is_not_found(
    void) {
    int arr[] = {1, 3, 4, 6, 8, 9, 11};
    size_t length = sizeof(arr) / sizeof(arr[0]);
