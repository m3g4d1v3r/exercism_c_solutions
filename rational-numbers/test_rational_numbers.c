...
static void test_absolute_value_of_rational_number_reduced_to_lowest_terms(
    void) {
    rational_t r = {2, 4};
    rational_t expected = {1, 2};
    rational_t actual = absolute(r);
...
static void test_raise_positive_rational_number_to_positive_integer_power(
    void) {
    rational_t r = {1, 2};
    int16_t n = 3;
...
static void test_raise_negative_rational_number_to_positive_integer_power(
    void) {
    rational_t r = {-1, 2};
    int16_t n = 3;
    rational_t expected = {-1, 8};
...
static void test_raise_positive_rational_number_to_negative_integer_power(
    void) {
    rational_t r = {3, 5};
    int16_t n = -2;
...
static void test_raise_negative_rational_number_to_even_negative_integer_power(
    void) {
    rational_t r = {-3, 5};
    int16_t n = -2;
    rational_t expected = {25, 9};
...
static void test_raise_negative_rational_number_to_odd_negative_integer_power(
    void) {
    rational_t r = {-3, 5};
    int16_t n = -3;
...
int main(void) {
    ...
    RUN_TEST(
        test_raise_negative_rational_number_to_even_negative_integer_power);
