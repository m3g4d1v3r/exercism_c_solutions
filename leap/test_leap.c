...
static void test_year_divisible_by_100_not_divisible_by_400_in_common_year(
    void) {
    TEST_ASSERT_FALSE(leap_year(2100));
}

static void test_year_divisible_by_100_but_not_by_3_is_still_not_a_leap_year(
    void) {
...
static void test_year_divisible_by_400_but_not_by_125_is_still_a_leap_year(
    void) {
    TEST_ASSERT_TRUE(leap_year(2400));
}

static void test_year_divisible_by_200_not_divisible_by_400_in_common_year(
    void) {
