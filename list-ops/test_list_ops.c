...
static void test_foldl_direction_independent_function_applied_to_non_empty_list(
    void) {
    list = new_list(4, (list_element_t[]){1, 2, 3, 4});
...
static void test_foldl_direction_dependent_function_applied_to_non_empty_list(
    void) {
...
static void test_foldr_direction_independent_function_applied_to_non_empty_list(
    void) {
    list = new_list(4, (list_element_t[]){1, 2, 3, 4});
    list_element_t initial = 5;
    list_element_t expected = 15;
...
static void test_foldr_direction_dependent_function_applied_to_non_empty_list(
    void) {
    list = new_list(2, (list_element_t[]){2, 5});
    list_element_t initial = 5;
    list_element_t expected = 2;
