...
static void test_translation_stops_if_stop_codon_at_beginning_of_sequence(
    void) {
    proteins_t expected = {
        .valid = true,
        .count = 0,
...
static void test_translation_stops_if_stop_codon_at_end_of_two_codon_sequence(
    void) {
    proteins_t expected = {
        .valid = true,
        .count = 1,
...
static void test_translation_stops_if_stop_codon_at_end_of_three_codon_sequence(
    void) {
    proteins_t expected = {
        .valid = true,
        .count = 2,
