...
static void test_deletes_the_element_with_the_specified_value_from_the_list(
    void) {
    list_push(list, 71);
    list_push(list, 83);
    list_push(list, 79);
...
static void test_delete_does_not_modify_the_list_if_the_element_is_not_found(
    void) {
    list_push(list, 89);
